    ...
    <header className="site-header">
      ...
      <div className="container nav-shell">
        <Link href="/" className="brand" aria-label="H Soares Seguros">
          <img src="/assets/logo-hsoares-transparent.png" alt="H Soares Seguros" className="brand-logo" />
        </Link>
        ...
        <div className="nav-actions">
          <Link href="/login" className="admin-icon-btn" aria-label="Acesso do administrador" title="Acesso do administrador">
