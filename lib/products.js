export const products = [
  {
    ...
    name: 'Seguro Fiança',
    category: 'Locação',
    shortDescription: 'Garantia locatícia com resultado na hora, operação 24h e fechamento mais rápido da locação.',
    longDescription:
    ...
    fiancaCoverageBlocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'A H Soares valida a melhor estrutura antes do fechamento.'
        ]
      }
    ],
    ...
    fiancaDocuments: [
      ...
      'Contratação mais rápida para acelerar o fechamento da locação.'
    ],
    fiancaPartners: [
      { name: 'Porto', logo: '/assets/insurers/porto.svg' },
    ...
    fiancaPlatform: {
      ...
      bullets: [
        ...
        'Fluxo disponível a qualquer dia e horário para acelerar aprovação e fechamento.',
    ...
    imobiliarioCoverageBlocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Mais previsibilidade para imobiliária e proprietário no fechamento do contrato.',
      ...
      },
      {
        ...
        items: [
          ...
          'Mais velocidade para concluir a locação e reduzir demora comercial.'
        ]
      }
    ],
  ...
  },
  {
    ...
    overview: [
      'Comparativo comercial entre operadoras para evitar escolha baseada só em preço.',
    ...
    hiringSteps: [
      ...
      'Ajudamos na leitura comercial de custo, carência, acomodação e cobertura.',
      'Seguimos com a proposta escolhida e acompanhamos o fechamento até a adesão.'
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    overview: [
      ...
      'Acompanhamento comercial da H Soares para apoiar decisão e fechamento.'
    ],
    coverages: [
    ...
    whoItsFor: [
      ...
      'Quem busca proteção auto com orientação comercial especializada.'
    ],
    hiringSteps: [
      'Entendimento de perfil e uso do veículo com a H Soares.',
      'Validação comercial de cobertura e custo.',
    ...
    faqs: [
      ...
      { q: 'Posso tirar dúvidas antes de contratar?', a: 'Sim. Nossa equipe comercial faz orientação prévia para você decidir com segurança.' },
    ...
    portoUrl: 'http://www.porto.vc/AZULPORASSINATURA_64947J_bf6578aa7006410bb39b828d82d19805',
    status: 'ativo'
  },
  {
    ...
    category: 'Financeiro',
    shortDescription: 'Cartão com proposta de benefícios e relacionamento no ecossistema Porto.',
    longDescription:
      'Página comercial para apresentar as vantagens do Cartão Porto Bank e conduzir o cliente com clareza para solicitação no link oficial. A H Soares atua para orientar o melhor uso do produto e aumentar conversão qualificada.',
    heroImage:
      'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1800&q=80',
    overview: [
      'Produto financeiro com foco em praticidade e benefícios conforme elegibilidade.',
      'Solicitação digital com fluxo de validação da instituição.',
      'Apoio comercial para posicionar o produto correto ao perfil do cliente.'
    ],
    coverages: [
      'Benefícios e condições sujeitos às políticas vigentes do Porto Bank.',
      'Condições de aprovação mediante análise cadastral e de crédito.',
      'Possibilidade de recursos adicionais conforme o plano aprovado.'
    ],
    whoItsFor: [
      'Clientes que buscam centralizar gastos com cartão estruturado.',
      'Quem deseja benefícios no relacionamento com Porto Bank.',
      'Perfis que valorizam controle financeiro digital.'
    ],
    hiringSteps: [
      'Análise do perfil e objetivo financeiro com a H Soares.',
      'Direcionamento para o link oficial de solicitação.',
      'Preenchimento e avaliação no ambiente Porto Bank.',
      'Acompanhamento comercial para suporte em dúvidas.'
    ],
    faqs: [
      { q: 'A aprovação é garantida?', a: 'Não. A aprovação depende da análise de crédito e critérios internos do Porto Bank.' },
      { q: 'Posso contratar diretamente pelo link?', a: 'Sim. O link já direciona para sua jornada de solicitação oficial.' },
      { q: 'A H Soares faz análise de crédito?', a: 'Não. A análise é do Porto Bank. A H Soares oferece apoio comercial e orientação.' },
      { q: 'Posso comparar com outros produtos financeiros?', a: 'Sim. Podemos orientar conforme seu objetivo de uso.' }
    ],
    portoUrl: 'http://www.porto.vc/CARTAODECREDITOPORTOBANK_BX46YJ_f4c3225ecf55455d9d89261efa53fdba',
    status: 'ativo'
  },
  {
    ...
    longDescription:
      'A Conta Digital Porto Bank atende clientes que desejam conveniência e operação digital. A H Soares posiciona o produto com foco consultivo-comercial, explicando o valor prático da solução e conduzindo ao link oficial.',
    heroImage:
    ...
    overview: [
      ...
      'Suporte comercial para reduzir dúvidas antes da adesão.'
    ],
    coverages: [
    ...
    hiringSteps: [
      'Alinhamento comercial com a H Soares.',
    ...
    faqs: [
      ...
      { q: 'A H Soares administra minha conta?', a: 'Não. A gestão é do Porto Bank. Nós atuamos na orientação comercial.' },
    ...
    portoUrl: 'http://www.porto.vc/CONTADIGITALPORTOBANK_64947J_babe026dcf814d6aa219ff48aa2ddaf3',
    status: 'ativo'
  },
  {
    ...
    longDescription:
      'O seguro para equipamentos portáteis reduz o impacto de imprevistos com itens de alto uso. A página foi construída para explicar com clareza o valor da proteção e conduzir para contratação oficial com suporte comercial da H Soares.',
    heroImage:
    ...
    overview: [
      ...
      'Acompanhamento da corretora para aumentar confiança no fechamento.'
    ],
    coverages: [
    ...
    hiringSteps: [
      ...
      'Validação comercial da melhor rota de contratação.',
    ...
    portoUrl: 'http://www.porto.vc/EQUIPAMENTOSPORTATEIS_BX46YJ_a99e784fb1be44c18348e059cfa4b14c',
    status: 'ativo'
  },
  {
    ...
    hiringSteps: [
      ...
      'Orientação comercial sobre cobertura e limite.',
    ...
    portoUrl: 'http://www.porto.vc/RESIDENCIAESSENCIAL_BX46YJ_bef065486e5e4e8a9a879f428df9d74c',
    status: 'ativo'
  },
  {
    slug: 'seguro-auto',
    name: 'Seguro Auto',
    category: 'Auto',
    shortDescription: 'Seguro auto com orientação consultiva e foco em fechamento rápido.',
    longDescription:
      'Com o Seguro Auto, você protege seu veículo com cobertura adequada ao seu perfil de uso. A H Soares atua no equilíbrio entre proteção e preço para aumentar assertividade comercial e reduzir indecisão no fechamento.',
    heroImage:
      'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1800&q=80',
    overview: [
      'Análise comercial para definir coberturas realmente necessárias.',
      'Direcionamento para contratação oficial com rastreio de origem.',
      'Apoio da corretora desde a cotação até o fechamento.'
    ],
    coverages: [
    ...
    whoItsFor: [
      ...
      'Quem busca atendimento humano com velocidade comercial.'
    ],
    hiringSteps: [
      'Entendimento de perfil do condutor e veículo.',
      'Definição comercial da melhor estratégia de contratação.',
    ...
    portoUrl: 'http://www.porto.vc/SEGUROAUTO_BX46YJ_086fd71fbcc3422daf98e5167934e695',
    status: 'ativo'
  },
  {
    slug: 'seguro-celular',
    name: 'Seguro Celular',
    category: 'Equipamentos',
    shortDescription: 'Proteção para smartphone com contratação digital simples.',
    longDescription:
      'O Seguro Celular atende quem depende do aparelho para trabalho, estudos e rotina pessoal. A página destaca benefícios e fluxo de contratação com menos atrito, mantendo suporte comercial da H Soares.',
    heroImage:
      'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=1800&q=80',
    overview: [
      'Cobertura para aparelhos elegíveis conforme política vigente.',
      'Fluxo de contratação digital com finalização no ambiente oficial.',
      'Suporte consultivo para escolher a solução adequada.'
    ],
    coverages: [
      'Coberturas e franquias definidas pelo plano contratado.',
      'Condições de elegibilidade do aparelho no momento da contratação.',
      'Regras de acionamento conforme cláusulas da seguradora.'
    ],
    whoItsFor: [
      'Usuários que possuem smartphone de alto valor.',
      'Profissionais que dependem do celular para faturamento.',
      'Clientes que querem evitar impacto financeiro em caso de imprevistos.'
    ],
    hiringSteps: [
      'Avaliação rápida do perfil e tipo de aparelho.',
      'Orientação da corretora para contratação assertiva.',
      'Redirecionamento ao link oficial de finalização.',
      'Acompanhamento em eventuais dúvidas de preenchimento.'
    ],
    faqs: [
      { q: 'Posso contratar para aparelho usado?', a: 'Depende das regras de elegibilidade exibidas no fluxo oficial.' },
      { q: 'A vigência começa no mesmo dia?', a: 'A confirmação de vigência segue regras da seguradora.' },
      { q: 'É obrigatório preencher no site da H Soares?', a: 'Não. A microcaptura é opcional; você pode seguir direto para contratação.' },
      { q: 'A H Soares recebe meu pedido?', a: 'Sim, registramos a origem e podemos acompanhar comercialmente.' }
    ],
    portoUrl: 'http://www.porto.vc/SEGUROCELULAR_64947J_ceb456af6b834ea38f9d936efd5813df',
    status: 'ativo'
  },
  {
    slug: 'seguro-vida-on',
    ...
    category: 'Vida',
    shortDescription: 'Proteção financeira pessoal e familiar com processo digital.',
    longDescription:
      'O Seguro de Vida ON busca simplificar a contratação de proteção financeira para quem quer planejar segurança da família. A H Soares estrutura a jornada comercial para acelerar decisão e conclusão.',
    heroImage:
    ...
    overview: [
      ...
      'Apoio comercial para explicar valor real da proteção.'
    ],
    coverages: [
    ...
    hiringSteps: [
      ...
      'Direcionamento comercial para o formato mais aderente.',
      'Encaminhamento para finalização no link oficial.',
      'Acompanhamento comercial da jornada.'
    ],
    faqs: [
    ...
    portoUrl: 'http://www.porto.vc/SEGURODEVIDAON_64947J_3f6db323cb5e47be85572e557c7dcf77',
    status: 'ativo'
  },
  {
    ...
    longDescription:
      'Seguro para quem trabalha com imagem e depende da disponibilidade dos equipamentos. A H Soares reforça o posicionamento comercial do produto para profissionais e criadores que não podem parar.',
    heroImage:
    ...
    overview: [
      ...
      'Jornada digital e suporte comercial para contratação.'
    ],
    coverages: [
    ...
    hiringSteps: [
      ...
      'Ajuste comercial de posicionamento do produto.',
    ...
    faqs: [
      ...
      { q: 'A H Soares acompanha o fechamento?', a: 'Sim. Nossa equipe acompanha comercialmente para reduzir abandono no funil.' }
    ],
    portoUrl: 'http://www.porto.vc/SEGUROFOTOEVIDEO_64947J_3f8390fda980467399a04521484c9b4d',
    status: 'ativo'
  },
  {
    ...
    longDescription:
      'Seguro voltado para clientes que utilizam notebook e tablet como ativos essenciais. A proposta comercial é proteger continuidade de rotina e produtividade com jornada de contratação objetiva.',
    heroImage:
    ...
    hiringSteps: [
      ...
      'Orientação comercial para escolha do caminho mais assertivo.',
    ...
    faqs: [
      ...
      { q: 'Posso falar com a H Soares antes de concluir?', a: 'Sim, nosso time comercial pode orientar antes da finalização.' }
    ],
    portoUrl: 'http://www.porto.vc/SEGURONOTEBOOKETABLET_64947J_c72bbc7e2fca4844a9fbc760454353cd',
    status: 'ativo'
  },
  {
    ...
    longDescription:
      'Produto voltado para clientes que investem em equipamentos smart e games. A página reforça valor de proteção do ativo e facilidade de contratação com suporte comercial ativo.',
    heroImage:
    ...
    overview: [
      ...
      'Fluxo de contratação digital e orientado à conversão.',
      'Apoio comercial para acelerar decisão.'
    ],
    coverages: [
    ...
    hiringSteps: [
      'Apoio comercial inicial para entendimento do produto.',
      'Direcionamento para contratação no link oficial.',
    ...
    portoUrl: 'http://www.porto.vc/SEGUROSMARTEGAMES_64947J_c633d49b22dd46d3ba61960d3f60309f',
    status: 'ativo'
  },
  {
    slug: 'seguro-viagem',
    ...
    longDescription:
      'O Seguro Viagem oferece suporte em situações críticas durante o deslocamento. A H Soares conduz o cliente com explicação comercial clara para contratação com segurança e rapidez no link oficial.',
    heroImage:
    ...
    hiringSteps: [
      ...
      'Orientação comercial sobre a melhor rota de contratação.',
    ...
    portoUrl: 'http://www.porto.vc/VIAGEM_64947J_21f978736285438ca82801123068ff97',
    status: 'ativo'
  }
];
